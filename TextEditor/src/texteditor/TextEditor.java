...
public class TextEditor extends JFrame implements ActionListener 
{
    ...
    JFrame createEditorWindow() 
    {
        editorWindow = new JFrame("NotePad");
    ...
    void saveFile(File filename) 
    {
        try
        {
            ...
            writer.close();
            saved = true;
            editorWindow.setTitle("NotePad - " + filename.getName());
        }
    ...
    private void openingFiles(File filename) 
    {
        try
        {
            ...
            //to write the opened file on text area
    ...
    public void actionPerformed(ActionEvent event) 
    {
        ...
        {
            //returns a PrinterJob which is initially associated with the default printer. 
            job = PrinterJob.getPrinterJob();
            //for pagesetup dialog box
